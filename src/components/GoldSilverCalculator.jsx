            ...
            return (
                <div className="container">
                        ...
                        <div className="collapse multi-collapse show" id="multiCollapseExample1">
                            ...
                            <form>
                                <div>
                                    ...
                                    <input type="number" min={1} className="form-control1" value={goldrate} onChange={e => setGoldrate(+e.target.value)}/>
                                </div>
                                <div>
                                    <label>Gold Weight in grams</label>
                                    <input type="number" min={1} className="form-control1" value={goldweight} onChange={e => setGoldweight(+e.target.value)}/>
                                </div>
                                <div>
                                    <label>Wastage in %</label>
                                    <input type="number" min={0} className="form-control1" value={wastage} onChange={e => setWastage(+e.target.value)}/>
                                </div>
                        ...
                        <div className="collapse multi-collapse" id="multiCollapseExample2">
                            ...
                            <form>
                                <div>
                                    ...
                                    <input type="number" min={1} className="form-control2" value={silverRate} onChange={e => setSilverRate(+e.target.value)}/>
                                </div>
                                <div>
                                    <label>Silver Weight in grams</label>
                                    <input type="number" min={1} className="form-control2" value={silverWeight} onChange={e => setSilverWeight(+e.target.value)}/>
                                </div>
                    ...
                    <div className="footerBlock">
                        <p className="footerNote">Developed based on indian gold & silver market standards by <a href="https://github.com/ajeshvp" target="_blank" rel="noreferrer">Ajesh VP</a> </p>
                    </div>
                </div>
